...
static const char qt_meta_stringdata_EditorDelegate[] = {
    "EditorDelegate\0"
};
...
const QMetaObjectExtraData EditorDelegate::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject EditorDelegate::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_EditorDelegate,
      qt_meta_data_EditorDelegate, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &EditorDelegate::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EditorDelegate))
