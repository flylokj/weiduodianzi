	...
	: CBasePage(tr("SetupPage"), index, previndex, add,parent )
{
	...
	ui.scanBtn->setStyleSheet("QPushButton{border-image:url(:/weiduodianzi/ui/scan.png);}""QPushButton:focus{border-image:url(:/weiduodianzi/ui/scanfocus.png);outline: 0px}");
}
...
void SetupPage::on_scanBtn_clicked()
{
	g_pMainWindow->changePage( SCANPAGE_INDEX );
}
