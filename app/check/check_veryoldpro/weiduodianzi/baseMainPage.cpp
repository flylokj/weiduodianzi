...
void  BaseMainPage::navigatorPageAt(int index, bool force)
{
	...
	qDebug()<<"5555555555555555555_1111111111111";
	if(!checkPermission() && !force)
		return;
	qDebug()<<"5555555555555555555_2222222222222";
	changeNavigator(index);
	qDebug()<<"5555555555555555555_33333333333333";
	...
	qDebug()<<"5555555555555555555_44444444444444444";
	ui.bottomWidget->changeNavigatorDisp(index);//改变导航栏显示;
	qDebug()<<"5555555555555555555_555555555555555555555";
	changePage(navigatorPageIndex.at(index));
	qDebug()<<"5555555555555555555_666666666666666666666666";
}
