...
void MyTableModel::createModelAndConnectToView(QTableView *parent, int column, int *pWidthArray, int tableIndex, bool bEdit)
{
...
QVariant MyTableModel::headerData(int section, Qt::Orientation orientation, int role /*= Qt::DisplayRole */) const //另外封装的函数
{
	...
	{
		qDebug()<<tableData.at(0);
		if( tableData.count() >0 )
			return tableData.at(0).at(section);
	}
