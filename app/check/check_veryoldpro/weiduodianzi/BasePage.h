...
#define CHECKGLOBALSTYLE 	"QCheckBox::indicator:unchecked {image: url(:/weiduodianzi/ui/signalflag0.png);}""QCheckBox::indicator:checked {image: url(:/weiduodianzi/ui/signalflag1.png);}""QCheckBox:focus{border: 0px solid green;outline: 0px;}"
